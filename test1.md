...
Here are 28 gages in CAMELS that meet certain selection criteria, but that I have not yet calibrated.

Selection Criteria:  gage in 'WA OR ID MT' and max elev>2000 and 1950 GAGESII (PRISM) pcp >250 mm

After previewing, and removing two that are glacial meltwater contaminated (Hoh, Thunder Creek), leaving 26:
